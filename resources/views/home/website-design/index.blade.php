...
<div class="page-wrapper page-website">
                    ...
                    <div class="col-11 col-md-8 col-lg-7 col-xl-6">
                        <div class="grid-hero__wrapp">
                            <div class="grid-hero__content">
                                <div class="box-hero">
                                    <h4 class="sub" data-cms="{{app()->getLocale()}}-website-index-14">WE ARE shopkenhtiktok</h4>
                ...
                <div class="col-12 col-lg-8">
                    <div class="grid-solution__content">
                        <div class="grid-solution--title" data-cms="{{app()->getLocale()}}-website-index-39">
                            WE HAVE SOLUTIONS TO ALL OF YOUR PROBLEMS AT shopkenhtiktok - CUSTOM WEBSITE DESIGN AT YOUR FINGERTIP.
                        </div>
                    </div>
                </div>
                <div class="col-0 col-lg-2"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="grid-why__content">
                                ...
                                <h3 data-cms="{{app()->getLocale()}}-website-index-61">If you want to run a highly profitable business, then choose shopkenhtiktok</h3>
                                <p data-cms="{{app()->getLocale()}}-website-index-62">shopkenhtiktok not only able to build well design ecommerce website, but also include impactful features. It is beautiful, user-friendly, and easy to maintain</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="grid-why__support-title">
                                <span data-cms="{{app()->getLocale()}}-website-index-68">shopkenhtiktok</span>
        ...
        <div class="container">
            <div class="grid-head">
                ...
                <div class="sapo">
                    ...
                    <p data-cms="{{app()->getLocale()}}-website-index-135">As a business owner, you need to know where to get AFFORTABLE, REPUTATIONAL, &amp; WELL DESIGN website. Therefore, shopkenhtiktok offers different packages that you can easily choose from to suit your business' needs</p>
                </div>
            </div>
    ...
    <div class="grid-field">
        <div class="container">
            <div class="grid-head">
                <h2 class="title" data-cms="{{app()->getLocale()}}-website-index-193">shopkenhtiktok DESIGNS WEBSITE FOR MANY DIFFERENT FIELDS</h2>
                <div class="sapo" data-cms="{{app()->getLocale()}}-website-index-194">Online business is becoming the norm nowaday. Become a pioneer and a leader in your given field by taking advandage of technology. shopkenhtiktok will support your every needs</div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="box-question">
                                    ...
                                    <div class="box-question__sapo" data-cms="{{app()->getLocale()}}-website-index-241">The website that build by shopkenhtiktok will have quality contents, well design and highly SEO optimized so that it is will be easily found on Google. In addition, It is lightweight, so you can expect a short load time</div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="box-question">
                                    ...
                                    <div class="box-question__sapo">
                                        <p data-cms="{{app()->getLocale()}}-website-index-246">shopkenhtiktok had built their headquaters in major city like Ho Chi Minh City or Da Nang. This will make it easier for you to reach and work with us</p>
    ...
    <div class="grid-website-work">
        <div class="container">
            <div class="grid-head">
                ...
                <h3 class="subtitle" data-cms="{{app()->getLocale()}}-website-index-252">shopkenhtiktok PROFESSIONAL WEBSITE DESIGN</h3>
            </div>
            <div class="grid-content">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="box-work">
                            ...
                            <div class="box-work__sapo" data-cms="{{app()->getLocale()}}-website-index-261">To get thing started, shopkenhtiktok will need your basic business information such as vision, mission, core value, etc. The more information and the more detail that you give us, the more complete your custom website will be come</div>
                        </div>
                    </div>
