...
<div class="page-wrapper page-about">
    ...
    <div class="grid-about-me">
        <div class="container">
            <div class="grid-head">
                <h2 class="title" data-cms="{{app()->getLocale()}}-about-index-52">Chúng tôi là shopkenhtiktok</h2>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-4 col-lx-4">
                    <div class="grid-support__title">
                        ...
                        <span data-cms="{{app()->getLocale()}}-about-index-105">shopkenhtiktok</span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-lx-6 d-flex align-items-end">
                    <div class="grid-reason__title">
                        ...
                        <span class="text" data-cms="{{app()->getLocale()}}-about-index-140">REASONS TO <br> CHOOSE shopkenhtiktok</span>
                    </div>
                </div>
