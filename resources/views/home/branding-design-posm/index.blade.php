...
<div class="page-wrapper page-logo">
                ...
                <div class="col-12 col-md-5 col-lg-5">
                    <div class="grid-logo-flex__content">
                        <ul class="support-list">
                            <li>
                                <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
                                <div class="text" data-cms="{{app()->getLocale()}}-brand-index-43">shopkenhtiktok will raise your business to be even more professional with a stood out branding.</div>
                            </li>
                            <li>
                                <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
    ...
    <div class="grid-partner">
        <div class="container">
            ...
            <div class="grid-head">
                <div class="sapo" data-cms="{{app()->getLocale()}}-brand-index-77">We are proud of the quality and the accomplishments of our designers. We believe that the logo design by shopkenhtiktok will aid your first step to win the competitive market places</div>
            </div>
        </div>
    </div>
