                        ...
                        <div class="video-container" style="position: relative; text-align: right">
                            ...
                            <div class="box-price">
                                <div class="btn-normal" style="margin-top: 10px; display: inline-block;">
                                    <a style="background: #4F4F4F; border-radius: 24px;" href="/mua-kenh-tiktok"
                                        title="Get to know us">
                                        <span style="color: white !important" class="btn-normal__title"
                                            data-cms="{{ app()->getLocale() }}-index-330">Xem bảng giá</span>
            ...
            <div class="box-call">
                ...
                <div class="sapo" style="max-width:740px">
                    ...
                    <div class="btn-normal" style="margin-top: 10px;">
                        <a style="background: #4F4F4F; border-radius: 24px;" href="/@lang('channels')"
                            title="Get to know us">
                            <span style="color: white !important" class="btn-normal__title"
                                data-cms="{{ app()->getLocale() }}-index-30">Danh sách kênh Tiktok</span>
                            <svg style="color: white !important" class="icon">
                                <use xlink:href="#icon-arrow"></use>
                            </svg>
                        </a>
...
@section('js')
    ...
    `,
            ...
            confirmButtonText: '<i class="fa fa-thumbs-up"></i> Hủy',
