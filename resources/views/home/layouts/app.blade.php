...
<head>
    ...
    <body id="body-site">
            ...
            <div id="navigation__title" class="navigation__title menu">
                <nav class="site-nav">
                    <ul class="my-menu">
                        ...
                        <li class="my-item"> <a href="/@lang('news')" class="navigation__link">@lang('News')</a>
                        </li>
                        <li class="my-item"> <a href="/@lang('contact')" class="navigation__link">@lang('Contact')</a>
                        </li>
                        <li class="my-item"><a href="#"> <a href="/thong-tin-thanh-toan"
                                    class="navigation__link">Thông tin thanh toán</a></a></li>

                    </ul>
                </nav>
            </div>
            <h3 id="navigation__title" class="navigation__title" style="color:white !important"
                data-cms="{{ app()->getLocale() }}-layouts-app-23">LIÊN HỆ HOTLINE: 0988.50.8769 </h3>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="header__logo-box d-flex align-items-center">
                            <a href="/" title="logo">
                                <img style="padding:10px;" class="img-fluid" @src="/images/home/shopkenhtiktok-logo.png"
                                    alt="{{ config('app.name') }}">
                            </a>
                        </div>
                    </div>
        ...
        <footer class="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            <div class="footer-content">
                                ...
                                <ul class="footer-list">
                                    <li class="sub-item">
                                        <a href="/mua-kenh-tiktok"
                                            data-cms="{{ app()->getLocale() }}-layouts-app-footer-5">Bán kênh Tiktok</a>
                                    </li>
                        ...
                        <div class="col-8 col-md-3 col-lg-3">
                            <div class="footer-content">
                                <h3 class="title" data-cms="{{ app()->getLocale() }}-layouts-app-footer-10">
                                    @lang('Follow us')</h3>
                                <div class="fb-page" data-href="https://www.facebook.com/shopkenhtiktok" data-tabs=""
                                    data-width="" data-height="" data-small-header="false"
                                    data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                    <blockquote cite="https://www.facebook.com/shopkenhtiktok"
                                        class="fb-xfbml-parse-ignore"><a
                                            href="https://www.facebook.com/shopkenhtiktok">Mua Bán Kênh Tiktok - MK
                                            Media</a></blockquote>
                                </div>
                            </div>
                        </div>
            ...
            <div class="copyright">
                <p>@lang('Design by') shopkenhtiktok</p>
            </div>
        </footer>
