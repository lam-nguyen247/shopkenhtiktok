...
<div class="page-wrapper page-digital">
    ...
    <div class="grid-call grid-call--digital grid-style--arrowdown">
        <div class="container">
            <div class="box-call">
                <div class="sapo">
                    <p data-cms="{{app()->getLocale()}}-digital-index-15">Digital Marketing is the perfect solution to promote your brand, products và and services to the potential customers. In this digital age, marketing has became easier, but the effect that it brought is undeniable. shopkenhtiktok's digital marketing solution is a smart choice that will make your business breakthrough.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                            <div class="box-marketing__content">
                                ...
                                <div class="box-marketing__sapo" data-cms="{{app()->getLocale()}}-digital-index-38">Google Ads is a potential solution for many businesses. shopkenhtiktok is highly specialized of ultilizing Google Ads to bring the best result.</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                            <div class="box-marketing__content">
                                ...
                                <div class="box-marketing__sapo" data-cms="{{app()->getLocale()}}-digital-index-70">Google Ads is a potential solution for many businesses. shopkenhtiktok is highly specialized of ultilizing Google Ads to bring the best result.</div>
                                <ul class="support-list">
                                    <li>
                                        <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                            <div class="box-marketing__content">
                                ...
                                <div class="box-marketing__sapo" data-cms="{{app()->getLocale()}}-digital-index-102">Google Ads is a potential solution for many businesses. shopkenhtiktok is highly specialized of ultilizing Google Ads to bring the best result.</div>
                                <ul class="support-list">
                                    <li>
                                        <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                            <div class="box-marketing__content">
                                ...
                                <div class="box-marketing__sapo" data-cms="{{app()->getLocale()}}-digital-index-134">Google Ads is a potential solution for many businesses. shopkenhtiktok is highly specialized of ultilizing Google Ads to bring the best result.</div>
                                <ul class="support-list">
                                    <li>
                                        <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 offset-lg-1">
                            <div class="box-marketing__content">
                                ...
                                <div class="box-marketing__sapo" data-cms="{{app()->getLocale()}}-digital-index-166">Google Ads is a potential solution for many businesses. shopkenhtiktok is highly specialized of ultilizing Google Ads to bring the best result.</div>
                                <ul class="support-list">
                                    <li>
                                        <svg class="icon"><use xlink:href="#icon-plus"></use></svg>
